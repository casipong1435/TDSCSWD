...
onMounted(() => {
    ...
    form.compositions = props.beneficiary?.aics_compositions?? null;
...
function submitForm() {
    ...
    form.put(route('staff.update-aics-beneficiary', props.beneficiary.id),{
        onSuccess: (page) => {
            Swal.fire({
                toast: true,
                icon: "success",
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-4 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div class="p-12 border">
                    ...
                    <form @submit.prevent="submitForm()">
                        ...
                        <div class="col-span-2 lg:col-span-1 flex justify-start items-center">
                            ...
                            <input type="text" id="gis_no"
                                class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:border-0 w-full lg:w-60" v-model="form.id" disabled>
                        </div>
                        <div class="col-span-2 lg:col-span-1 flex justify-start lg:justify-end items-center">
                            <label for="date" class="me-2">Date:</label>
                            <input type="date" id="date" v-model="form.date" :disabled="beneficiary.status == 1"
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="col-span-2 md:col-span-1">
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_name" v-model="form.ik_name" :disabled="beneficiary.status == 1"
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_age" v-model="form.ik_age" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60 focus:ring-0">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_address" v-model="form.ik_address" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60 focus:ring-0">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_occupation" v-model="form.ik_occupation" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60 focus:ring-0">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_monthly_income" v-model="form.ik_monthly_income" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60 focus:ring-0">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_relation" v-model="form.relation_to_beneficiary" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                        </div>
                        <div class="col-span-2 md:col-span-1">
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="date" id="ik_birthdate" v-model="form.ik_birthdate" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <select id="ik_sex" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60" v-model="form.ik_sex" :disabled="beneficiary.status == 1">
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <select id="ik_civil_status" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60" v-model="form.ik_civil_status" :disabled="beneficiary.status == 1">
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_education" v-model="form.ik_education" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="ik_mobile_number" v-model="form.ik_mobile_number" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        <div class="col-span-2 md:col-span-1">
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="name" v-model="form.name" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="age" v-model="form.age" :disabled="beneficiary.status == 1"
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="address" v-model="form.address" :disabled="beneficiary.status == 1"
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="occupation" v-model="form.occupation" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="monthly_income" v-model="form.monthly_income" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                        </div>
                        <div class="col-span-2 md:col-span-1">
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="date" id="birthdate" v-model="form.birthdate" :disabled="beneficiary.status == 1"
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <select id="sex" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60" v-model="form.sex" :class="{'border-red-700': errors.sex}" :disabled="beneficiary.status == 1">
                                        <option value="Male">Male</option>
                                        <option value="Female">Female</option>
                                    </select>
                                </span>
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <select id="civil_status" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60" v-model="form.civil_status" :class="{'border-red-700': errors.civil_status}" :disabled="beneficiary.status == 1">
                                        <option value="Single">Single</option>
                                        <option value="Married">Married</option>
                                        <option value="Divorced">Divorced</option>
                                        <option value="Widowed">Widowed</option>
                            ...
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="education" v-model="form.education" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                            <div class="flex flex-col lg:flex-row justify-between  ml-8">
                                ...
                                <span class="flex items-center">
                                    <span>:</span>
                                    <input type="text" id="mobile_number" v-model="form.mobile_number" :disabled="beneficiary.status == 1"
                                        class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full lg:w-60">
                                </span>
                            </div>
                    ...
                    <button v-if="beneficiary.status == 0" type="button" @click="addRow" class="btn rounded-none btn-primary mb-1">
                            ...
                            <tbody>
                                <tr v-for="(composition, index) in form.compositions" :key="index">
                                    <td colspan="2" class="px-4 py-3 border"><input type="text"
                                            v-model="composition.comp_name" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0"></td>
                                    <td class="px-4 py-3 border"><input type="text" v-model="composition.comp_age" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0">
                                    </td>
                                    <td class="px-4 py-3 border"><input type="text"
                                            v-model="composition.comp_relation_to_client" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0">
                                    </td>
                                    <td class="px-4 py-3 border"><input type="text"
                                            v-model="composition.comp_education" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0">
                                    </td>
                                    <td class="px-4 py-3 border"><input type="text"
                                            v-model="composition.comp_occupation" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0">
                                    </td>
                                    <td class="px-4 py-3 border"><input type="text"
                                            v-model="composition.comp_monthly_income" :disabled="beneficiary.status == 1" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0">
                                    </td>
                                    <td>
                                        <button v-if="beneficiary.status == 0" type="button" @click="removeRow(index, composition.id)" class="text-red-700">
                    ...
                    <!--Social Worker's Assessment-->
                    <div class="w-full">
                        <textarea id="swa" class="w-full" rows="5" v-model="form.social_worker_assessment" :disabled="beneficiary.status == 1"></textarea>
                    </div>
                    <div class="my-8">
                        <div class="flex flex-col lg:flex-row lg:items-center">
                            ...
                            <span class="grid grid-cols-2 items-center">
                                ...
                                <select id="toa" class="border-t-0 border-r-0 border-l-0 focus:outline-none focus:ring-0 w-full col-span-2 lg:col-span-1" v-model="form.type_of_assistance" :disabled="beneficiary.status == 1">
                            ...
                            <span class="grid grid-cols-2 items-center">
                                ...
                                <input type="text" id="amount_provided" v-model="form.amount_provided" :disabled="beneficiary.status == 1"
                                ...
                                <div class="grid grid-cols-2 gap-2">
                                    ...
                                    <div class="col-span-1 p-1">
                                        <div class="flex flex-col py-5">
                                            ...
                                            <select id="interview" class="w-full mt-5" v-model="form.interviewee" :disabled="beneficiary.status == 1">
                                    ...
                                    <div class="col-span-1 p-1">
                                        <div class="flex flex-col py-5">
                                            ...
                                            <select id="interview" class="w-full mt-5" v-model="form.reviewee" :disabled="beneficiary.status == 1">
                                                <option :value="staff.id" v-for="staff in aics_staff" :key="staff.id">{{ staff.name }}</option>
                                            </select>
                                            <span class="flex flex-row justify-start items-center mt-5">
                                                <label for="position_int">Position:</label>
                    ...
                    <div class="w-full flex justify-end items-center gap-2 mt-5">
                        <ProcessingButton type="submit" :process="form.process" :text="'Save'" class="rounded-none" v-if="beneficiary.status == 0"/>
                        <Link :href="route('staff.aics')" class="btn rounded-none">Back</Link>
                    </div>
                    </form>
                </div>
            </div>
