...
const approveList = () => {
    ...
    router.put(route("admin.approve-program-list", usePage().props.program.id), {}, {
        onSuccess: (page) => {
...
function filtersearchInput() {
    router.get(route('public', usePage().props.program.id),
...
watch(searchInput, (value) => {
    if (value == "") {
        router.get(route('admin.program_info', usePage().props.program.id),
            { searchInput: value },
            {
                preserveState: true,
                replace: true
        ...
        <section class="bg-gray-50 dark:bg-gray-900 p-4 sm:p-5">
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12 mb-10">
                <div class="breadcrumbs text-sm mb-2">
                    <ul>
                        <li>
                            <Link :href="route('admin.request.programs')">Program</Link>
                        </li>
                        <li>
                            <a>Program Info</a>
                        </li>
                    ...
                    <div class="col-span-2 md:col-span-1 py-2">
                        <div class="shadow-lg p-3 rounded gap-y-3">
                            <div class="flex justify-between items-center py-2 border-b">
                                ...
                                <a target="_blank" :href="route('admin.individualProgramReport', usePage().props.program.id)" class="text-red-700 hover:text-red-900">
                ...
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div
                        ...
                        <div v-if="program.status == 2"
                            ...
                            <ProcessingButton :process="processing" :text="'Approve'" @click="approveList()" />
