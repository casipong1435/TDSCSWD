...
function filtersearchInput(){
    router.get(route('admin.request_info', usePage().props.request_info.id),
...
const respondRequest = () => {
    ...
    router.put(route('admin.respondRequest', requestID), {}, {
        onSuccess: page => {
            Swal.fire({
                toast: true,
                icon: 'success',
            ...
            <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                    ...
                    <div class="breadcrumbs text-sm">
                        <ul>
                            <li>
                                <Link :href="route('admin.request.beneficiaries',)">Requests</Link>
                            </li>
                            <li>
                    ...
                    <div
                        ...
                        <div
                            ...
                            <button v-if="request_info.status < 3" type="button" @click="openAcceptRequestModal"
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <ProcessingButton type="button" :process="processing" :text="'Confirm'" class="btn bg-green-600 hover:bg-green-800"
