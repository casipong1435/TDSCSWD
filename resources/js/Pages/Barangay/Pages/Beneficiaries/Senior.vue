...
<template>
    ...
    <Barangaypage>
        <Head title="Senior Beneficiaries" />
    <section class="bg-gray-50 dark:bg-gray-900 p-4 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div class="text-2xl p-2 mb-2">Senior Beneficaries</div>
                <div
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="benefeciary in benefeciaries.data" :key="benefeciary.id"
                                ...
                                <td class="px-4 py-3">{{ benefeciaryCategoryName(benefeciary.benefeciary_type) }}</td>
