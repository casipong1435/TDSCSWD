            ...
            <div class="flex items-center lg:order-2">
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    ...
                    <span v-if="unreadNotifications.length > 0"
                        class="dot dot-error h-3.5 w-3.5 absolute right-2 top-2 text-white flex justify-center items-center"
                ...
                <button type="button"
                    ...
                    <img v-if="auth_user.user_image" class="w-8 h-8 rounded-full"
                        :src="'/profile_images/' + auth_user.user_image" alt="user photo" />
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    id="dropdown">
                    <div class="py-3 px-4">
                        <span class="block text-sm font-semibold text-gray-900 dark:text-white">{{ auth_user.name
                            }}</span>
