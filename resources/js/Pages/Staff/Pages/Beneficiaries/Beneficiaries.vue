...
function filter() {
    router.get(route('staff.all-beneficiaries'),
        {
...
const findBeneficiaries = async () => {
    ...
    try {
        const response = await axios.get(route('staff.findBeneficiaries'), {
            params: {
        ...
        <div class="modal" style="z-index: 9999">
            ...
            <div class="modal-content flex flex-col gap-5">
                ...
                <div v-if="result" class="flex justify-between gap-5 justify-center items-center">
                    ...
                    <div class="">
                        <a target="_blank" type="button" :href="category == 1 ? route('staff.exportToExcelSenior', JSON.stringify(barangay_ids)) : category == 2 ? route('staff.exportToExcelPwd', JSON.stringify(barangay_ids)) : route('staff.exportToExcelWomen', JSON.stringify(barangay_ids))" class=" text-green-700 hover:text-green-900" :class="{'disabled opcacity-80 pointer-events-none' : foundData <= 0}">
