...
function filter() {
    router.get(route('barangay.focals'),
...
const AddUser = () => {
    ...
    try {
        router.post(route('barangay.post-focals'), form, {
            onSuccess: page => {
                resetFields(),
                    isAddModalOpen.value = false,
...
const saveEditUserData = () => {
    processing.value = true;
    try {
        router.post(route('barangay.put-focals', user_id.value),
            {
                _method: 'put',
                ...form,
            },
...
const savePasswordEditUserData = () => {
    processing.value = true;
    try {
        router.put(route('barangay.put-focals-password', user_id.value), form, {
            onSuccess: page => {
...
const deleteUserData = () => {
    processing.value = true;
    try {
        router.delete(route('barangay.delete-focals', user_id.value), {
            onSuccess: page => {
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <ProcessingButton :process="processing" type="button" :text="'Confirm'" @click="deleteUserData"
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <ProcessingButton :process="processing" type="submit" :text="isAdd ? 'Submit' : 'Save'" />
                        </div>
                    </div>
                </div>
            </form>
